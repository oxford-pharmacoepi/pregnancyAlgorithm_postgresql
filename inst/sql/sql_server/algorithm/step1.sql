...
from
(
	select b.category, b.gest_value, person_id, a.CONDITION_CONCEPT_ID as CONCEPT_ID,  condition_start_date as start_date,  'Cond' as type, ' ' as value_as_string,cast(null as integer)  as value_as_number
	...
	union all
	select b.category, b.gest_value, person_id, a.PROCEDURE_CONCEPT_ID as CONCEPT_ID, procedure_date as start_date, 'Proc' as type, ' ' as value_as_string,cast(null as integer)  as value_as_number
